...
public class Cetak_siswa extends javax.swing.JPanel {
...
//    combBox Pilih Kelas
    private void updateCombo() {
        ...
        try {
            ...
            e.printStackTrace(); // Tambahkan logging kesalahan
        }
        ...
        jkelas.addActionListener((ActionEvent e) -> {
    ...
    void tampilkanDataSiswa() {
        ...
        String sql = "SELECT * FROM siswa WHERE kelas = ? AND status = 'Aktif'";
        try {
            ResultSet rs = SQLConnection.doPreparedQuery(sql, kelas);
            ...
            model.setColumnIdentifiers(new Object[]{"NIPD", "NISN", "Nama Siswa", "Kelas", "Status", "Jenis Kelamin", "Tempat Lahir", "Tanggal Lahir"});
            ...
            while (rs.next()) {
                ...
                model.addRow(new Object[]{nipd, nisn, namaSiswa, Kelas, status, jenisKelamin, tempatLahir, tanggalLahir});
            }
    ...
    public void cetak2() {
        try {
            ...
            InputStream reportSourceStream = getClass().getResourceAsStream("/Laporan/Laporan_Siswa.jrxml");
    ...
    private void initComponents() {
                ...
                .addGroup(jPanel4Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel4Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel4Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(jPanel4Layout.createSequentialGroup()
                                .addComponent(jkelas, javax.swing.GroupLayout.PREFERRED_SIZE, 160, javax.swing.GroupLayout.PREFERRED_SIZE)
                    ...
                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel4Layout.createSequentialGroup()
                        .addGroup(jPanel4Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                            .addGroup(jPanel4Layout.createSequentialGroup()
                                ...
                                .addGap(15, 15, 15))
                            .addGroup(jPanel4Layout.createSequentialGroup()
                                .addComponent(jkelas, javax.swing.GroupLayout.PREFERRED_SIZE, 34, javax.swing.GroupLayout.PREFERRED_SIZE)
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)))
        ...
        jLabel6.setText("Cetak Data Siswa");
    ...
    private void jkelasActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jkelasActionPerformed
        tampilkanDataSiswa();        // TODO add your handling code here:
